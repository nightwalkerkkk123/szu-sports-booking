...
class BackendRouter:
    ...
    def __init__(
        ...
        self._last_signals: Optional[RiskSignals] = None
    ...
    def request(
        ...
        first_attempt_backend: Optional[str] = None
        fell_back = False
        chosen_index = 0
    ...
    @property
    def last_signals(self) -> Optional[RiskSignals]:
        return self._last_signals

    @property
    def last_decision(self) -> Optional[RouteDecision]:
